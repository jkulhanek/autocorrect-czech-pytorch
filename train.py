...
from dataset import create_dataset, SOS_token, EOS_token
import random
import torch
import time
import math
...
def trainIters(dataset, encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    ...
    training_pairs = [dataset[random.randrange(len(dataset))] for i in range(n_iters)]
    ...
    for iter in range(1, n_iters + 1):
        ...
        loss = train(input_tensor, target_tensor, encoder,
                     decoder, encoder_optimizer, decoder_optimizer, criterion, dataset.max_length + 50)
...
trainIters(dataset, encoder1, attn_decoder1, 500, print_every=500)
